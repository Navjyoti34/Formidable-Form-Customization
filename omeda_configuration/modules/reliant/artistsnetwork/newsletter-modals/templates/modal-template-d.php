...
<html>
    ...
    padding-top: 15px;
			...
			.taglineOuter{
				...
				background-image:url(https://www.artistsnetwork.com/wp-content/uploads/2023/09/art-300x300-1.png);
    background-position: center;
    background-repeat: no-repeat;
    width: 45%;
    border-radius: 0;
	...
	<div class="background-container">
		...
		<div class="modalRight">
			...
			<div class="cta">
				<strong>Artists Network's newsletter</strong> will help you become the artist you've always wanted to be, with daily tips, tricks, and trainings to take your practice to the next level.
			</div>
			<form class="mainForm signup-form" action="/modal-thank-you">
				...
				<input type="hidden" id="promocode" name="promocode" value="arndefault0923">
				<input class="signup-button" type="submit" value="Sign me up!">
			</form>
			<div class="disclaimer">
				*I agree to receive emails from <strong><?php echo get_bloginfo('name'); ?></strong>, including educational resources, promotions, partner news and tips. I can unsubscribe at any time. For details on our data practices, visit our <a href="https://goldenpeakmedia.com/privacy-policy" target="_blank">Privacy Policy</a>.
			</div>
		</div>
	</div>
	</body>
